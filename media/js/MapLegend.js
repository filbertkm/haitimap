...
/* api: constructor
 *  .. class:: MapLegend(config)
 *
 *  A panel showing legends of all layers in a layer store.
 *  Depending on the layer type, a legend renderer will be chosen.
 */
GeoExt.MapLegend = Ext.extend(Ext.Panel, {

/* api: config[dynamic]
 *  ``Boolean``
 *  If false the MapLegend will not listen to the add, remove and change 
 ...
 */
    initComponent: function() {
        GeoExt.MapLegend.superclass.initComponent.call(this);
    },
 ...
 */
    onRender: function() {
        GeoExt.MapLegend.superclass.onRender.apply(this, arguments);
        if(!this.layerStore) {
 ...
 */
    onDestroy: function() {
        ...
        GeoExt.MapLegend.superclass.onDestroy.apply(this, arguments);
    }
});

/** api: xtype = gx_legendpanel */
Ext.reg('gx_maplegend', GeoExt.MapLegend);
